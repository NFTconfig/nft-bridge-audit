...
contract NFTBridgeGovernance is
    NFTBridgeGetters,
    NFTBridgeSetters,
    ERC1967Upgrade
{
    event NewPendingImplementation(
        address indexed pendingImplementation,
    ...
    function setWrappedAsset(
        uint16 tokenChainId_,
        bytes32 tokenAddress_,
        address wrapper_
    ) external onlyOwner {
        _setWrappedAsset(tokenChainId_, tokenAddress_, wrapper_);
    }
}
