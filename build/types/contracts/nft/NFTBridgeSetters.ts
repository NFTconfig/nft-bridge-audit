...
export interface NFTBridgeSettersInterface extends utils.Interface {
  functions: {
...
export interface NFTBridgeSetters extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTBridgeSettersInterface;
