...
export interface IZKBridgeReceiverInterface extends utils.Interface {
  functions: {
    "zkReceive(uint16,address,uint64,bytes)": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "zkReceive"): FunctionFragment;
...
export interface IZKBridgeReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IZKBridgeReceiverInterface;
